...
c***** Integrating motion in separatrix****
     ...
     *T0,dn,n_tr,dn_jump
      external func
      external Voltage
      OPEN (UNIT=13,file='results/Distr/17PhaseSpace.dat',
     *STATUS='unknown')
      OPEN (UNIT=14,file='results/Distr/17InitPhaseSpace.dat',
     *STATUS='unknown')
      OPEN (UNIT=15,file='results/Distr/17PhaseSpaceA.dat',
     *STATUS='unknown')

      OPEN (UNIT=16,file='results/Distr/17InDistribution.dat',
     *STATUS='unknown')
      OPEN (UNIT=17,file='results/Distr/17InTransform.dat',
     *STATUS='unknown')
      OPEN (UNIT=18,file='results/Distr/17Distribution.dat',
     *STATUS='unknown')
      OPEN (UNIT=19,file='results/Distr/17Transform.dat',
     *STATUS='unknown')

      OPEN (UNIT=20,file='results/Distr/17InDer.dat',
     *STATUS='unknown')
      OPEN (UNIT=21,file='results/Distr/17Der.dat',
     *STATUS='unknown')
      OPEN (UNIT=22,file='results/Distr/17DistributionAll.dat',
     *STATUS='unknown')

      OPEN (UNIT=23,file='results/Distr/17MNK.dat',
     *STATUS='unknown')
      OPEN (UNIT=24,file='results/Distr/17Deriv.dat',
     *STATUS='unknown')
c------constants--------
      proton = 938.0d0
      pi = 3.14159
...
c------parameters of turns and particles--------
      ...
      DO I1=1,Np
      OPEN (UNIT=25,file='results/Distr/16PhaseSpace.dat'
     *,STATUS='unknown')
      READ(25,*) turn_p(I1),tau(I1),dE(I1),dp_p(I1),dE_E(I1),
...
c------turn by N-turn--------
     ...
     *bin_count,bin_phi)
      ...
      DO j=1,k
      write(22,*) j,bin_count(j),Distr(j),bin_phi(j),turn
      END DO
