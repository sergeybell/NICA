...
c***** Integrating motion in separatrix****
     ...
     *T0,dn,n_tr,dn_jump
      external func
      external Voltage
      OPEN (UNIT=13,file='results/Distr/20PhaseSpace.dat',
     *STATUS='unknown')
      OPEN (UNIT=14,file='results/Distr/20InitPhaseSpace.dat',
     *STATUS='unknown')
      OPEN (UNIT=15,file='results/Distr/20PhaseSpaceA.dat',
     *STATUS='unknown')

      OPEN (UNIT=16,file='results/Distr/20InDistribution.dat',
     *STATUS='unknown')
      OPEN (UNIT=17,file='results/Distr/20InTransform.dat',
     *STATUS='unknown')
      OPEN (UNIT=18,file='results/Distr/20Distribution.dat',
     *STATUS='unknown')
      OPEN (UNIT=19,file='results/Distr/20Transform.dat',
     *STATUS='unknown')

      OPEN (UNIT=20,file='results/Distr/20InDer.dat',
     *STATUS='unknown')
      OPEN (UNIT=21,file='results/Distr/20Der.dat',
     *STATUS='unknown')
      OPEN (UNIT=22,file='results/Distr/20DistributionAll.dat',
     *STATUS='unknown')

      OPEN (UNIT=23,file='results/Distr/20MNK.dat',
     *STATUS='unknown')
      OPEN (UNIT=24,file='results/Distr/20Deriv.dat',
     *STATUS='unknown')
c------constants--------
      proton = 938.0d0
      pi = 3.14159
