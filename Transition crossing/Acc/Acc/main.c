...
char *fname=(char *)"PartCoord.dat";      // file name for particle coordinates: phi, DeltaP_P, ro
char *fnameZ=(char *)"impedance.dat";     // file name for effective impedances
char *fnameOut=(char *)"PartCoordOut.dat";  // file name for final particle coordinates
char *fnameCB=(char *)"AccCycleBunchPrm.dat";//file name for resulting turn-by-turn bunch parameters
char buf[256];
