...
int main (void){
FILE *fp, *fp1;
char *fnameCP="AccCycleParam.dat";//file name for particle coordinates: phi, DeltaP_P, ro
char *fname="PartCoord.dat";      // file name for particle coordinates: phi, DeltaP_P, ro
char *fnameZ="impedance.dat";     // file name for effective impedances
char *fnameOut="PartCoordOut.dat";  // file name for final particle coordinates
char *fnameCB="AccCycleBunchPrm.dat";//file name for resulting turn-by-turn bunch parameters
char buf[256];
